...
class CsvDataOrganizer:
    def __init__(self):
        self.source_folder = "/home/pierres/PROJET S7/recognAItion/data/filtered_audio_to_csv"
        self.samples_file = "/home/pierres/PROJET S7/recognAItion/data/sample.csv"
        self.labels_file = "/home/pierres/PROJET S7/recognAItion/data/labels.csv"
