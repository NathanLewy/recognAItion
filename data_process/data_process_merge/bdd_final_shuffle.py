...
class CSVProcessor:
    ...
    def shuffle_and_extract(self, output_sample_file, output_label_file, fraction=0.2):
        ...
        """
        # Ensure output files are cleared before saving new ones
        self.clear_file(output_sample_file)
        self.clear_file(output_label_file)
        ...
        print(sample_df_shuffled,label_df_shuffled)
...
processor.shuffle_and_extract(
    output_sample_file="/home/pierres/Projet_S7/recognAItion/data_final/sample_eval.csv",
